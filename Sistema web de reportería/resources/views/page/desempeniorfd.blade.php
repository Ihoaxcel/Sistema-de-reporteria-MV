...
@section('menu')
<li class="activado">
    <img class="icono izquierdo material-icons"  src="{{ URL::asset('/imagenes/radar_icono4.ico') }}">
    <p class="texto">Desempeño Social</p>
        <ul class="submenu">
            <li class="lisubmenu"><a onclick="sendUrl19();">Productos adecuados I</a></li>
            <li class="lisubmenu"><a onclick="sendUrl20();">Productos adecuados II</a></li>
            <li class="lisubmenu"><a onclick="sendUrl21();">Trato responsable a clientes</a></li>
            <li class="lisubmenu"><a onclick="sendUrl22();">Trato responsable a empleados</a></li>
            <li class="lisubmenu"><a onclick="sendUrl23();">Equilibrio financiero y social</a></li>
        </ul>
</li>
...
@section('contenido')
    ...
    <iframe id="iframeID" name="iframeID" width="100%" height="680px" style="background-image: url(../public/imagenes/radar_fondo_capitulos4.png);background-size: 100% 100%;background-position: 30px 110px;">
    </iframe>
@endsection