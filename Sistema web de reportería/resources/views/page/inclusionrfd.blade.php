...
@section('logoCentral')
    <a class="logotipoMenu" href="{{url('/cerrarPublico')}}">
...
@section('menu')
<li class="activado">
    <img class="icono izquierdo material-icons" src="{{ URL::asset('/imagenes/radar_icono5.ico') }}">
    <p class="texto">Inclusión Financiera</p>
    <ul class="submenu">
        <li class="lisubmenu "><a onclick="sendUrl27();">Global Findex</a></li>
        <li class="lisubmenu "><a onclick="sendUrl28();">Microscopio global</a></li>
        <li class="lisubmenu "><a onclick="sendUrl29();">ENEMDU acceso-uso</a></li>
    </ul>
</li>
<div class="subMenuLateral">
    <ul class="submenu1">
            <li class="">
                ...
                <ul class="subItems">
                    <li class="lisubmenu1"><a onclick="sendUrl24();">Empleo y Sectores económicos</a></li>
                    <li class="lisubmenu1"><a onclick="sendUrl25();">Inflación</a></li>
                    <li class="lisubmenu1"><a onclick="sendUrl26();">Exportaciones e importaciones</a></li>
                </ul>  
            </li>    
             <!--MENÚ DESAHABILITADO-->
            <li class="">
